    ...
    return (
        <div>
            ...
            <div className="level-row">
                ...
                <button className={`level-btn ${1 < unlockedLevel && "done"} ${1 > unlockedLevel && "locked"}`} onClick={() => goToLevel(1)}>
            ...
            <div className="level-row">
                <button className={`level-btn moveToRight ${2 < unlockedLevel && "done"} ${2 > unlockedLevel && "locked"}`} onClick={() => goToLevel(2)}>
