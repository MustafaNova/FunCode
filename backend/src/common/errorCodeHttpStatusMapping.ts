...
export const ERROR_CODE_TO_HTTP_STATUS: Record<ErrorCode, HttpStatus> = {
    ...
    PRACTICE_LEVEL_NOT_FOUND: HttpStatus.NOT_FOUND,
    ...
    CODE_GOLF_CHARACTER_LIMIT_EXCEEDED: HttpStatus.BAD_REQUEST,

    BUG_HUNTER_LEVEL_LOCKED: HttpStatus.FORBIDDEN,
    PRACTICE_LEVEL_NOT_SUBMITTABLE: HttpStatus.FORBIDDEN,
    FRIEND_REQUEST_ACCESS_DENIED: HttpStatus.FORBIDDEN,
    PRACTICE_LEVEL_LOCKED: HttpStatus.FORBIDDEN,
};