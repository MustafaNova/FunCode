...
import { CLAN_SOCKET_EVENTS, type JoinClanChatReq, type SendClanMsgReq } from '@funcode/shared';
...
export class ChatGateway
    ...
    async joinClanChat(
        ...
        @MessageBody() payload: JoinClanChatReq,
    ) {
    ...
    async leaveClanChat(
        ...
        await this.cs.leaveClanRoom(client);
    }

    @SubscribeMessage(CLAN_SOCKET_EVENTS.SEND_CLAN_MSG)
    async sendClanMsg(
        @ConnectedSocket() client: ChatSocket,
        @MessageBody() payload: SendClanMsgReq,
    ) {
